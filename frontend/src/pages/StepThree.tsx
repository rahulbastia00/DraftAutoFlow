    ...
    return (
        <div className="w-full space-y-8">
            <div className="text-center">
                <h2 className="text-2xl font-bold mb-2">AI-Powered Cold Email Generator</h2>
                <p className="text-gray-600">Generate personalized emails based on your application data</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-green-50 p-6 rounded-lg">
                    <h3 className="text-lg font-semibold mb-4"> Contacts from Database</h3>
